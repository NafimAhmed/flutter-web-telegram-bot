                        ...
                        children: [
                          TableRow(
                            ...
                            children: [
                              ...
                              TableCell(child: Text('Deposit', textAlign: TextAlign.center)),
                              TableCell(child: Text('Issued', textAlign: TextAlign.center)),
                              TableCell(child: Text('Not issued', textAlign: TextAlign.center)),
                            ],
                          ),
                          TableRow(
                            children: [
                ...
                for (int index = 0; index < controller.transectionModel.value.results!.length; index++)
                  ...
                  TableRow(
                    children: [
                      ...
                      TableCell(child: Obx(() => Text('${controller.transectionModel.value.results?[index].repliedBy}', textAlign: TextAlign.center))),
            ...
            Obx(() => controller.issueModel.value.results != null
              ...
              children: [
                ...
                for (int index = 0; index < controller.issueModel.value.results!.length; index++)
                  if(controller.issueModel.value.results![index].chatId!.contains(chatId??''))
                  TableRow(
                    children: [
                      TableCell(
                        child: Obx(() => Text(
                      ...
                      TableCell(
                        child: Obx(() {
                          double amount = controller.issueModel.value.results?[index].amount ?? 0;
                          return Text('$amount', textAlign: TextAlign.center);
                        }),
                      ),
                      TableCell(child: Obx(() => Text('${controller.issueModel.value.results?[index].reply}', textAlign: TextAlign.center))),
